...
import W_1KG        from '../assets/1kg.png';
...
export const products: Product[] = [
  ...
  // ── Avarage Wmix Cashews ──
  {
    ...
    image: IMG_WMIX, images: [IMG_WMIX],
  ...
  // ── Split Cashews ──
  {
    ...
    image: IMG_JHSPLITS, images: [IMG_JHSPLITS],
  ...
  // ── 4 Piece Cashews ──
  {
    ...
    image: IMG_4PIECE, images: [IMG_4PIECE],
  ...
  // ── 8 Piece Cashews ──
  {
    ...
    image: IMG_8PIECE, images: [IMG_8PIECE],
  ...
  // ── Kaju BB (Nooka) ──
  {
    ...
    image: IMG_KAJUBB, images: [IMG_KAJUBB],
  ...
  // ── Skin Cashews ──
  {
    ...
    image: IMG_SKIN, images: [IMG_SKIN],
...
export const categories = [
  ...
  { id: 'cat-6', name: 'W180 Jumbo Cashews', slug: 'w180-cashews',    image: W_1KG,        productCount: products.filter(p => p.category === 'w180-cashews').length },
  { id: 'cat-7', name: 'W240 Super Cashews', slug: 'w240-cashews',    image: W_1KG,        productCount: products.filter(p => p.category === 'w240-cashews').length },
  { id: 'cat-8', name: 'W320 Cashews',       slug: 'w320-cashews',    image: W_1KG,        productCount: products.filter(p => p.category === 'w320-cashews').length },
